...
\begin{frame}{Valor de $r$}
	...
	\onslide<2->De dicho valor depende la complejidad del resto del algoritmo.\break
	
	\onslide<3->Dicho valor se puede probar que está acotado superiormente por $\max\{3, \lceil\log^5(n)\rceil\}$.
\end{frame}
