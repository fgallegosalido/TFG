...
\setpartpreamble[c][0.75\linewidth]{%
	...
	Luego hablaremos de los tests de primalidad en general, su utilidad y describiremos algunos de los que se usan hoy en día.\\
...
\part{Análisis Matemático del Algoritmo AKS} % Dividir un libro en partes OPCIONAL

\input{capitulos/capitulo_1_1}
\input{capitulos/capitulo_1_2}
\input{capitulos/capitulo_1_3}
\input{capitulos/capitulo_1_4}
...
\cleardoublepage\part{Análisis Teórico y Empírico de la Complejidad del Algoritmo AKS}
\input{capitulos/capitulo_2_1}
\input{capitulos/capitulo_2_2}
\input{capitulos/capitulo_2_3}
\input{capitulos/capitulo_2_4}
...
\input{apendices/apendice_1}
\input{apendices/apendice_2}
\input{apendices/apendice_3}
